...
class LectureListServiceTest {
    ...
    void getLectureList_Recent() {
        // Given
        List<LectureListResponse> mockLectures = List.of(
            new LectureListResponse(1L, "최신 강의", 50000, "김강사", 5L, 10, LocalDateTime.now()),
            new LectureListResponse(2L, "이전 강의", 30000, "이강사", 3L, 15, LocalDateTime.now().minusDays(1))
        );
        Page<LectureListResponse> mockPage = new PageImpl<>(mockLectures);
        
        when(lectureRepository.findAllWithEnrollmentCountOrderByCreatedAt(any(Pageable.class)))
                .thenReturn(mockPage);
        
        // When
        Page<LectureListResponse> result = lectureService.getLectureList(1, 20, LectureSortType.RECENT);
    ...
    void getLectureList_PopularCount() {
        // Given
        List<LectureListResponse> mockLectures = List.of(
            new LectureListResponse(1L, "인기 강의", 50000, "김강사", 8L, 10, LocalDateTime.now()),
            new LectureListResponse(2L, "일반 강의", 30000, "이강사", 3L, 15, LocalDateTime.now())
        );
        Page<LectureListResponse> mockPage = new PageImpl<>(mockLectures);
        ...
        // When
        Page<LectureListResponse> result = lectureService.getLectureList(1, 20, LectureSortType.POPULAR_COUNT);
    ...
    void getLectureList_PopularRate() {
        // Given
        List<LectureListResponse> mockLectures = List.of(
            new LectureListResponse(1L, "고신청률 강의", 50000, "김강사", 9L, 10, LocalDateTime.now()),
            new LectureListResponse(2L, "저신청률 강의", 30000, "이강사", 3L, 15, LocalDateTime.now())
        );
        Page<LectureListResponse> mockPage = new PageImpl<>(mockLectures);
        ...
        // When
        Page<LectureListResponse> result = lectureService.getLectureList(1, 20, LectureSortType.POPULAR_RATE);
    ...
    void getLectureList_PageSizeLimit() {
        ...
        // When
        Page<LectureListResponse> result = lectureService.getLectureList(1, 200, LectureSortType.RECENT);
    ...
    void getLectureList_DefaultValues() {
        ...
        // When
        Page<LectureListResponse> result = lectureService.getLectureList(null, null, null);
